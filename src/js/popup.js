...
function getMessageText (model) {
  ...
  if (type == 1) {
    return `${date} по адресу ${address} автомобиль ${auto_type} (Государственный регистрационный номер ${auto_sign}) двигался с нарушением предписания знака 5.15.1 "Направление движения по полосам" создавая тем самым аварийную обстановку. Прошу привлечь к административной ответственности водителя указанного транспортного средства в соответствии с Ч.2 ст.12.16 КоАП и принять меры по предотвращению массового игнорирования дорожных знаков на данном участке дороги`
  }
}
